...
async function handlePlansIndex(url, request, env) {
  ...
  const description = 'Browse every workout plan combination — by goal, equipment and experience. Get your free custom 4-week plan.';
...
async function handleSeoLandingPage(goal, equipment, experience, url, request, env) {
  ...
  const description = `Get a personalized 4-week ${equipmentLower} workout plan for ${goalLower}, built for ${experienceLower} lifters. Generated free in 5 seconds. No signup required.`;
